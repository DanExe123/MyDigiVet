            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <form action="{{ route('appointments.store') }}" method="POST" id="appointment-form">
                            @csrf
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="zoom-in"
                                data-aos-duration="2000">
                                <!-- Vaccination Card -->
                                <div class="card bg-base-100 shadow-xl border border-black relative">
                                    <figure class="px-10 pt-10">
                                        <img src="https://autumntrailsvet.com/wp-content/uploads/2021/03/injection-for-dog.jpg"
                                            alt="Vaccination" class="rounded-xl" />
                                    </figure>
                                    <div class="card-body items-center text-center">
                                        <div class="card-actions mt-7 relative">
                                            ...
                                            <input type="checkbox" id="vaccination-checkbox"
                                                class="checkbox checkbox-md mt-3" name="services[]" value="Vaccination"
                                                style="display: none;" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-base-100 shadow-xl border border-black relative">
                                    <figure class="px-10 pt-10">
                                        <img src="https://media.istockphoto.com/id/1547703847/photo/dog-dewormer-with-food-in-hand-of-veterinarian-or-pet-owner.jpg?s=612x612&w=0&k=20&c=WMP0gSyEnq5r4bkfAuBcEJwKhMNxsmYSbn1b4Endcb8="
                                            alt="Deworming" class="rounded-xl" />
                                    </figure>
                                    <div class="card-body items-center text-center">
                                        <div class="card-actions mt-4">
                                            ...
                                            <input type="checkbox" id="deworming-checkbox" class="checkbox checkbox-md mt-3"
                                                name="services[]" value="Deworming" style="display: none;" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-base-100 shadow-xl border border-black relative">
                                    <figure class="px-10 pt-10">
                                        <img src="https://cdn.shopify.com/s/files/1/0259/9626/3490/files/dog-grooming-1.png?v=1665519040"
                                            alt="Pet Grooming" class="rounded-xl" />
                                    </figure>
                                    <div class="card-body items-center text-center">
                                        <div class="card-actions mt-6">
                                            ...
                                            <input type="checkbox" id="grooming-checkbox" class="checkbox checkbox-md mt-3"
                                                name="services[]" value="Pet Grooming" style="display: none;" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-base-100 shadow-xl border border-black relative">
                                    <figure class="px-10 pt-10">
                                        <img src="https://www.dogstrust.org.uk/images/800x600/assets/2022-09/labrador%20standing%20on%20vet%20table%20with%20treat.jpg"
                                            alt="Consultation" class="rounded-xl" />
                                    </figure>
                                    <div class="card-body items-center text-center">
                                        <div class="card-actions mt-2">
                                            ...
                                            <input type="checkbox" id="consultation-checkbox"
                                                class="checkbox checkbox-md mt-3" name="services[]" value="Consultation"
                                                style="display: none;" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col justify-start" data-aos="fade-right" data-aos-duration="2000">
                        <div id="calendar"
                            class="bg-white p-4 rounded-lg shadow-lg mb-5 w-full h-96 md:h-128 lg:h-144 xl:h-160"></div>
                    ...
                    <div class="max-w-xs mx-auto md:max-w-md bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-4"
                        data-aos="fade-left" data-aos-duration="2000">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2 mt-2">Select Clinic</label>
                            <select id="clinic-select" name="clinicname"
                                class="mt-2 block w-full p-2 border rounded-lg border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                required>
                                <option value="" disabled selected>Select a clinic</option>
                                @foreach ($clinics as $clinic)
                                    <option value="{{ $clinic->clinicname }}" data-clinic-id="{{ $clinic->id }}"
                                        data-details='{{ json_encode([
                                            ...
                                            'clinic_owner_id' => $clinic->user_id,
                                        ]) }}'>
                                        {{ $clinic->clinicname }}
                                    </option>
                                @endforeach
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                clinicSelect.addEventListener('change', function() {
                                    ...
                                    // Set the hidden input value to the clinic ID from the selected option's data attribute
                                    clinicIdInput.value = selectedOption.getAttribute('data-clinic-id');
                                });
                            });
                        </script>
                        ...
                        <div class="p-4 border-t border-gray-300">
                            ...
                            <ul class="list-disc list-inside text-gray-700">
                                ...
                                <li>Bring any medical records, vaccination history, or previous prescriptions for your pet.
                                </li>
                                <li>If your pet has any specific dietary or medication needs, please mention them during
                                    your visit.</li>
                                <li>Be prepared to discuss your pet's symptoms and any behavioral changes observed.</li>
                                <li>Contact the clinic in advance if you need to reschedule or have any questions regarding
                                    your appointment.</li>
                            </ul>
                        </div>
                        ...
                        <dialog id="my_modal_4" class="modal">
                            <div class="modal-box w-11/12 max-w-5xl">
                                ...
                                <div class="flex justify-between mb-4">
                                    ...
                                    <div
                                        class="max-w-sm rounded-lg overflow-hidden shadow-lg w-1/2 border-l-4 border-[#357D7F]">
                                        <div class="px-6 py-4">
                                    ...
                                    <div class="w-1/2 flex justify-center items-center">
                                        <img id="clinic-image"
                                            src="https://img.freepik.com/premium-vector/doctor-with-cats-doctor-room-with-cat-dog_1120557-15207.jpg?w=826"
                                            alt="Clinic Image" class="rounded shadow-lg w-full max-w-sm object-cover" />
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-center mb-4">
                                    <div
                                        class="max-w-3xl rounded-lg overflow-hidden shadow-lg custom-gradient p-6 text-white">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 relative z-10">
                                    ...
                                    <div
                                        class="max-w-sm rounded overflow-hidden shadow-lg p-4 bg-white border-l-4 border-[#357D7F] transition-transform duration-300 hover:scale-105">
                        ...
                        <button type="button" class="btn custom-bg-357D7F" onclick="my_modal_5.showModal()">Fillup
                            Form</button>
                    </div>
                </div>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        document.getElementById('clinic-select').addEventListener('change', function() {
                            ...
                            if (clinicDetails) {
                                ...
                                document.getElementById('clinic-description').textContent = selectedClinic
                                    .clinic_description;
                                document.getElementById('clinic-pricing_deworming').textContent = selectedClinic
                                    .pricing_deworming;
                                document.getElementById('clinic-pricing_vaccinated').textContent = selectedClinic
                                    .pricing_vaccinated;
                                document.getElementById('clinic-pricing_consultation').textContent = selectedClinic
                                    .pricing_consultation;
                                document.getElementById('clinic-pricing_petgrooming').textContent = selectedClinic
                                    .pricing_petgrooming;
                        ...
                        document.getElementById('save-button').addEventListener('click', function() {
                            if (selectedClinic) {
                                ...
                                alert(
                                    'Please select a clinic before saving.'); // Handle case where no clinic is selected
                            }
                        });
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div id="termsConditions" class="space-y-4">
                                            <div class="shadow-md text-justify">
                                                <p class="py-4 text-lg font-bold">"Appointments must be canceled or
                                                    rescheduled at least 24 hours in advance. Failure to do so may result in
                                                    a cancellation fee or a penalty affecting future bookings."</p>
                                                <div class="form-control">
                                                    <label class="label cursor-pointer">
                                                        <span class="label-text">I AGREE</span>
                                                        <input type="checkbox" name="agreed_cancellation" id="checkbox-1"
                                            ...
                                            <div class="shadow-md text-justify">
                                                <p class="py-4 text-lg font-bold">"All services must be paid in full at the
                                                    time of the appointment unless prior arrangements have been made."</p>
                                                <div class="form-control">
                                                    <label class="label cursor-pointer">
                                                        <span class="label-text">I AGREE</span>
                                                        <input type="checkbox" name="agreed_payment" id="checkbox-2"
                                                            value="1" class="checkbox" />
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="shadow-md text-justify">
                                                <p class="py-4 text-lg font-bold">"The clinic requires accurate and
                                                    complete medical history of the pet to provide optimal care. By booking
                                                    an appointment."</p>
                                                <div class="form-control">
                                                    <label class="label cursor-pointer">
                                                        <span class="label-text">I AGREE</span>
                                                        <input type="checkbox" name="agreed_liability" id="checkbox-3"
                                                            value="1" class="checkbox" />
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="btn-group flex justify-end mt-10 space-x-0">
                                            ...
                                            <a href="{{ route('Appointment.index') }}"
                                                class="btn custom-bg-357D7F text-cyan-50 rounded-l-none">Close</a>
                                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.isClosed) {
                            alert(
                                'Your selected date is closed or fully booked. Please choose another date.'
                            );
                        } else {
