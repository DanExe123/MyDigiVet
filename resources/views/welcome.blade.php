...
<body>
    ...
    <nav class="bg-white shadow sticky top-0 z-10">
        <div class="container mx-auto flex justify-between items-center px-4 py-4">
            ...
            <div class="text-xl font-bold text-[#357D7F]">
                <a href="welcome" class="flex items-center">
                    <img src="{{ asset('logo/Veterinary Clinic System_20240517_125656_0000.png.png') }}"
                        alt="Clinic Logo" class="h-10">
            ...
            <div id="nav-menu" class="hidden lg:flex flex-1 justify-center">
                <ul class="flex space-x-8">
                    <li><a href="#welcome" class="text-gray-600 hover:text-gray-800 transition font-poppins">Home</a>
                    </li>
                    <li><a href="#about" class="text-gray-600 hover:text-gray-800 transition font-poppins">About</a>
                    </li>
                    <li>
                        <a href="#services"
                            class="text-gray-600 hover:text-gray-800 transition relative border-b-2 border-[#357D7F] font-poppins">
                            Our Services
                        </a>
                    </li>
                    <li><a href="#payment" class="text-gray-600 hover:text-gray-800 transition font-poppins">Payment</a>
                    </li>
                    <li><a href="#pet-health" class="text-gray-600 hover:text-gray-800 transition font-poppins">Pet
                            Health</a></li>
                    <li><a href="#features"
                            class="text-gray-600 hover:text-gray-800 transition font-poppins">Features</a></li>
                </ul>
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('register') }}"
                    class="bg-gray-800 text-white px-4 py-2 rounded hover:bg-[#0f0f0f] transition">Register</a>
            </div>
        </div>
        ...
        <div id="mobile-menu" class="lg:hidden hidden">
            <ul class="flex flex-col items-center space-y-2 py-4">
                ...
                <li><a href="#" class="text-gray-600 hover:text-gray-800 transition font-poppins">Pet Health</a>
                </li>
                <li><a href="#" class="text-gray-600 hover:text-gray-800 transition font-poppins">Features</a>
                </li>
            </ul>
    ...
    <div class="flex h-screen">
        ...
        <section class="flex-none w-1/2 h-full relative" data-aos="fade-up" data-aos-duration="3000">
            <img src="{{ asset('logo/welcomebg.png') }}" alt="Welcome Background" class="w-full h-full object-cover">
            <!-- Image fills the section height -->
            <!-- Gray overlay with 50% opacity -->

        </section>

        <!-- Section 2: Content Section -->
        <section class="flex-none w-1/2 h-full flex flex-col items-start p-8 relative" data-aos="fade-left"
            data-aos-duration="3000"> <!-- Align items to the top -->
            <h2 class="text-3xl font-bold text-gray-800">Welcome to <span class="text-[#357D7F]">Digi Vet</span></h2>
            <p class="mt-4 text-gray-600">Your trusted partner in pet health and wellness. We offer a range of services
                to keep your pets happy and healthy.</p>
            <blockquote class="mt-4 italic text-gray-500 border-l-4 border-[#357D7F] pl-4">
                "The greatness of a nation and its moral progress can be judged by the way its animals are treated." -
                Mahatma Gandhi
            </blockquote>
            <p class="mt-4 text-gray-600">Join us in creating a healthier and happier environment for your furry
                friends. Together, we can make a difference!</p>
            <a href="#" class="mt-6 bg-[#357D7F] text-white px-4 py-2 rounded hover:bg-[#2f6d6f] transition">Read
                More</a>
    ...
    <!-- Cards Section -->
    <section id="services" class="py-12 bg-white bg-cover bg-center"
        style="background-image: url('{{ asset('logo/bgpetacc.jpg') }}');">
        <h1 class="text-3xl font-bold text-center mb-8" data-aos="zoom-in" data-aos-duration="2000">Our Services</h1>
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">


            <!-- Vaccination Card -->
            <div class="bg-[#357D7F] p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105"
                ...
                <p class="mt-2 text-gray-200 text-center">Comprehensive vaccination services to keep your pets
                    protected.</p>
            </div>
            ...
            <div class="bg-[#357D7F] p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105"
                ...
                <p class="mt-2 text-gray-200 text-center">Professional grooming to keep your pet looking and feeling
                    their best.</p>
            </div>
        ...
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between">
            ...
            <div class="lg:w-1/2 p-8" data-aos="zoom-in-right" data-aos-duration="1500">
                ...
                <p class="mt-4 text-gray-600">
                    At Digi Vet, we believe that pet health is paramount. Our comprehensive health plans are designed to
                    keep your furry friends in their best shape. From vaccinations to regular check-ups, we offer a
                    range of services tailored for your pet’s needs.
                </p>
                <p class="mt-4 text-gray-600 mb-5">
                    ...
                    are dedicated to serving your pets with the utmost care and love.
                </p>
                <a href="#"
                    class="mt-10 bg-[#357D7F] text-white px-4 py-2 rounded hover:bg-[#2f6d6f] transition">
                    Learn More
                </a>
            </div>
    ...
    <section id="about" class="py-12">
        <div class="relative bg-cover bg-center" style="background-image: url('{{ asset('logo/secbg.jpg') }}');"
            ...
            <div class="bg-black bg-opacity-50 py-12"> <!-- Semi-transparent overlay -->
                <div class="container mx-auto text-center">
                    ...
                    <p class="mt-4 text-gray-300">
                        At Digi Vet, we are dedicated to transforming the veterinary industry. Our innovative system
                        empowers veterinary clinics to embrace digital solutions, streamline operations, and enhance
                        patient care.
                        We believe in a future where technology and compassion work hand in hand to ensure every pet
                        receives the best possible care.
                    </p>
                    <p class="mt-4 text-gray-300">
                        Join us on our journey to revolutionize pet healthcare by providing the tools and resources
                        necessary for clinics to operate more efficiently and effectively. Let us help you make your
                        clinic more digital, organized, and ready for the future!
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="features" class="py-12 bg-white">
        <div class="container mx-auto text-center" data-aos="fade-down" data-aos-easing="linear"
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="flex-1">
                    ...
                    <div class="space-y-4">
                        ...
                        <div
                            class="relative bg-[#357D7F] p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl group">
                            <div class="flex items-center mb-2">
                                <i class="fas fa-user-circle mr-2 text-xl"></i>
                                <span class="text-lg text-white">Account Features</span>
                            </div>
                            <p
                                class="absolute bottom-0 left-0 right-0 bg-white text-gray-800 p-4 rounded-lg hidden group-hover:block">
    ...
    <section id="payment" class="py-12 bg-gray-100">
        <div class="container mx-auto text-center" data-aos="fade-up" data-aos-duration="1500">
            <h2 class="text-3xl font-bold text-gray-800 mb-4">Payment Options</h2>
            <p class="mt-4 text-gray-600">
                Choose your preferred subscription plan and payment method to enjoy our services seamlessly. We accept
                both GCash and Bank Transfer for your convenience.
            </p>

            <div class="mt-8 flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-6">
                <!-- Subscription Card -->
                <div
                    class="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
                    <h3 class="text-xl font-bold mb-2">Basic Plan</h3>
                    <p class="text-gray-600 mb-4">₱500 for 1 month access. Perfect for small pet owners looking to
                        manage their pets' health.</p>
                    <div class="relative group">
                        <button class="bg-[#357D7F] text-white px-4 py-2 rounded-lg transition hover:bg-[#2A5B5B]">
                            Guide Payment
                        </button>
                        <div
                            class="absolute left-1/2 transform -translate-x-1/2 bottom-12 w-48 bg-gray-800 text-white text-sm rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">₱800 for 1 month access. Ideal for pet owners with multiple pets who
                        need additional features.</p>
                    <div class="relative group">
                        <button class="bg-[#357D7F] text-white px-4 py-2 rounded-lg transition hover:bg-[#2A5B5B]">
                            Guide Payment
                        </button>
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">₱1200 for 1 month access. Best for clinics looking for comprehensive
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto text-center">
            ...
            <p class="mt-4 text-gray-600">
                When you choose to pay for your access plan, please follow the steps below for a smooth payment
                experience.
            </p>

            <div class="flex flex-col md:flex-row justify-center items-start">
                <!-- Phone Mockup Section -->
                <div class="flex justify-center w-full md:w-1/2 mb-8 md:mb-0" data-aos="zoom-in-right"
                    data-aos-duration="1500">
                    <div class="mockup-phone border-primary">
                        <div class="camera"></div>
                        <div class="display">
                            <div class="artboard artboard-demo phone-1">
                                <img src="{{ asset('logo/phone.png') }}" alt="Payment Instructions"
                                    class="mx-auto my-2" style="max-width: 90%; height: auto;">
                                <div
                                    ...
                                    <p class="text-center">Hi. You can follow the instructions above for your payment.
                                    </p>
                ...
                <div class="w-full md:w-1/2 flex flex-col justify-center">
                    <div class="grid grid-cols-1 gap-8">
                        <!-- Step 1 -->
                        <div class="bg-gray-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105"
                            data-aos="zoom-in-left" data-aos-duration="1500">
                            <h3 class="text-xl font-bold mb-2">Step 1: Choose Your Plan</h3>
                            <p class="text-gray-600">
                                Select the subscription plan that best suits your clinic's needs from the payment
                                options available.
                            </p>
                        </div>
                        ...
                        <div class="bg-gray-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105"
                            ...
                            <p class="text-gray-600">
                                Proceed with the payment through GCash or Bank Transfer. Ensure that you follow the
                                instructions provided during checkout.
                            </p>
                        </div>

                        <!-- Step 3 -->
                        <div class="bg-gray-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105"data-aos="zoom-in-left"
                            data-aos-duration="1500">
                            <h3 class="text-xl font-bold mb-2">Step 3: Wait for Confirmation</h3>
                            <p class="text-gray-600">
                                After making the payment, please wait for a confirmation from our Super Admin. This
                    ...
                    <div class="mt-8" data-aos="zoom-in-left">
                        ...
                        <p class="text-gray-600 mt-2">
                            If you do not receive confirmation within 24 hours, please contact our support team for
                            assistance.
                        </p>
                    </div>
                </div>
    ...
    <footer class="footer bg-white text-base-content p-10 mt-2 relative overflow-hidden" data-aos="zoom-in-up"
        data-aos-duration="1500">
        <div class="absolute inset-0 z-0">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#357D7F" fill-opacity="1"
        ...
        <aside class="relative z-10">
            <img src="{{ asset('logo/Veterinary Clinic System_20240517_125656_0000.png.png') }}" alt="Clinic Logo"
                class="h-16 mb-4">
            <p>
