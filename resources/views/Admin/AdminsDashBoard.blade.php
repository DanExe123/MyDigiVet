...
@section('header')
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-4 mt-6">
                    <!-- card1 JS -->
                         <a href="{{ route('admin.MonthlyVaccinated.index') }}" class="block w-full">
                <div class="card bg-base-100 image-full w-full shadow-xl h-30 flex">
                    <div class="card-body flex justify-between items-center w-full">
                        ...
                        <figure class="ml-auto">
                            <img class="h-16 w-16" src="{{ asset('logo/experimentation.png') }}" alt="Icon" />
                        </figure>
                    </div>
                </div>
            </a>
        ...
        <a href="{{ route('admin.MonthlyConsultation.index') }}" class="block w-full">
            <div class="card bg-base-100 image-full w-full shadow-xl h-30 flex">
                <div class="card-body flex justify-between items-center w-full">
                    ...
                    <figure class="ml-auto">
                        <img class="h-16 w-16" src="{{ asset('logo/veterinary.png') }}" alt="Dog Consultation Icon" />
                    </figure>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('admin.MonthlyDeworming.index') }}" class="block w-full">
            <div class="card bg-base-100 image-full w-full shadow-xl h-30 flex">
                <div class="card-body flex justify-between items-center w-full">
                    ...
                    <figure class="ml-auto">
                        <img class="h-16 w-16" src="{{ asset('logo/worm.png') }}" alt="Icon" />
                    </figure>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('admin.MonthlyPetGrooming.index') }}" class="block w-full">
            <div class="card bg-base-100 image-full w-full shadow-xl h-30 flex">
                <div class="card-body flex justify-between items-center w-full">
                    ...
                    <figure class="ml-auto">
                        <img class="h-16 w-16" src="{{ asset('logo/grooming.png') }}" alt="Icon" />
                    </figure>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('admin.MonthlyCancelled.index') }}" class="block w-full">
            <div class="card bg-base-100 image-full w-full shadow-xl h-30 flex mb-6">
                <div class="card-body flex justify-between items-center w-full">
                    <div class="text-left">
                        <h2 class="card-title">Monthly <br>Cancelled Appointment<br> Report</h2>
                    </div>
                    <figure class="ml-auto">
                        <img class="h-16 w-16" src="{{ asset('logo/cancel-event.png') }}" alt="Icon" />
                    </figure>
                                </div>
                            </div></a>
                        </div>
