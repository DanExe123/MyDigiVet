...
@section('content')
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                <h1 class="text-left font-bold mb-6 text-3xl">Monthly Deworming Report {{ \Carbon\Carbon::now()->format('F, Y') }}</h1>
                <div id="content" class="slide-up">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                        <div class="bg-gray-700 shadow-xl flex p-4 items-center rounded max-w-xs md:max-w-sm h-44 mt-10">
                            <figure class="flex-shrink-0 mr-4">
                                <img class="h-20 w-20 object-cover" src="{{ asset('logo/worm.png') }}" alt="Icon" />
                            </figure>
                            <div class="flex flex-col text-right">
                                <p class="text-cyan-50 font-extrabold text-3xl">
                                    <span class="text-cyan-50 ml-3">{{ $totalDeworming }}</span>
                                    <span class="text-cyan-50 ml-3">Total</span>
                                </p>
                                <p class="text-cyan-50 font-extrabold text-3xl mt-2">Deworming</p>
                    ...
                    <div class="mt-12">
                        <div class="overflow-x-auto">
                            <table id="dewormingTable" class="min-w-full divide-y divide-gray-200 bg-white shadow-md rounded-lg">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($DewormingnAppointments as $appointment)
                                    <tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#dewormingTable').DataTable({
                "paging": true,
                "searching": true,
                "ordering": true,
                "info": true,
        ...
        const myBarChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Monthly Dewormings',
                    data: @json($monthlyDeworming), // Make sure to pass this data from your controller
